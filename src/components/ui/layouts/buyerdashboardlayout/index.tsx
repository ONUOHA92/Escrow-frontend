...
const navigation = [
    { name: 'Dashboard', href: '/buyer/dashboard', icon: HomeIcon, current: true },
    { name: 'Team', href: '#', icon: UsersIcon, current: false },
    { name: 'Payment', href: '/buyer/payments', icon: FolderIcon, current: false },
                                                        ...
                                                        {navigation.map((item) => (
                                                            <li key={item.name}>
                                                                ...
                                                                >
                                                                    <item.icon
                                                                        className={classNames(
                                                                            item.current ? 'text-purple-900' : 'text-gray-400 group-hover:text-purple-600',
                                                                            'h-6 w-6 shrink-0'
                                                                        )}
                                                                        aria-hidden="true"
                                                                    />
