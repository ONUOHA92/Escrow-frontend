...
const stats = [
  ...
  { name: "Transtion Count", stat: "10" },
  { name: "Pending Statement ", stat: "₦30,000" },
  { name: "Amount in wallet ", stat: "₦30,000" },
];
  ...
  return (
    <SellerLayout>
      <div>
        ...
        <dl className="mt-5 grid grid-cols-1 lg:text-center gap-5 sm:grid-cols-4">
          {stats.map((item) => (
            <div
              key={item.name}
              className="overflow-hidden rounded-lg bg-purple-700 px-4 py-5 shadow sm:p-6"
            >
