...
const Feature = () => {
  return (
    <>
      <AnimationOnScroll
        animateOnce
        animateIn="animate__fadeInUp  origin-bottom"
      >
        <div className="mt-[-60px]">
          <div className="mx-auto max-w-7xl px-6  lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className=" text-4xl pt-20 font-bold tracking-tight text-purple-900 sm:text-3xl">
                Buy and Sell with Total Confidence
              </h2>
              <p className="mt-6 text-lg leading-8 text-gray-700">
                Whether you are buying that dream item or selling to eager
                customers online, Safetrade provides a secure and transparent
                way to safeguard your transactions, ensuring your money stays
                safe and your orders reach you as promised.
              </p>
            </div>
