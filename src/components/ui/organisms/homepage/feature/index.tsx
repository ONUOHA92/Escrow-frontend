        ...
        <div className="mx-auto max-w-7xl px-6  lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-700">
              ...
              customers online, Safetrade provides a secure and transparent way
              to safeguard your transactions, ensuring your money stays safe and
              your orders reach you as promised.
            </p>
          </div>
